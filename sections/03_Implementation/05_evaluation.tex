...
A better approach is to look at the following metrics which can be derived form the confusion matrix for every category (3). 
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{gb_roc_and_auc.png}
\end{figure}

\begin{figure}[!tbp]
    \centering
    \begin{minipage}[b]{0.4\textwidth}
      \includegraphics[width=\textwidth]{gb_roc_and_auc.png}
      \caption{Feature Importance Gradient Boosting}
    \end{minipage}
    \hfill
    \begin{minipage}[b]{0.4\textwidth}
      \includegraphics[width=\textwidth]{dt_roc_and_auc.png}
    \end{minipage}
  \end{figure}
