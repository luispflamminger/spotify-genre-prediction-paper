...
\begin{figure}[H]
    \centering
    \subfloat[\centering Correlation matrix: categorie \emph{rock}]{{\includegraphics[width=4cm]{output_rock.png} }}%
    \qquad
    \subfloat[\centering Correlation matrix: categorie \emph{hiphop}]{{\includegraphics[width=4cm]{output_Hip_Hop.png} }}%
    \qquad
    \subfloat[\centering Correlation matrix: categorie \emph{jazz}]{{\includegraphics[width=4cm]{output_jazz.png} }}%
...
If we now look at the data in a distribution plot (\ref{fig:du_dp_bp_enrg_categorie_dependent}),
