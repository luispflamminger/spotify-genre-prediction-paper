...
\begin{figure}[H]
    ...
    \qquad
    \subfloat[\centering Boxplot: "Loudness"]{{\includegraphics[width=4cm]{output_Loudness_boxplot.png} }}%
...
%\begin{figure}[H]
%    \centering
%    \subfloat[\centering Distribution plot: "Instrumentalness"]{{\includegraphics[width=4cm]{output_instumentelness.png.} }}%
%    \qquad
%    \subfloat[\centering Boxplot: "Instrumentalness"]{{\includegraphics[width=4cm]{output_instumentelness_boxplot.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Distribution plot: "Energy"]{{\includegraphics[width=4cm]{output_energy.png} }}%
    \qquad
    \subfloat[\centering Boxplot: "Energy"]{{\includegraphics[width=4cm]{output_energy_boxplot.png} }}%
...
\begin{figure}[H]
    ...
    \qquad
    \subfloat[\centering Boxplot: Speechiness]{{\includegraphics[width=4cm]{output_Speechiness_Boxplot.png} }}%
    \qquad
    \subfloat[\centering Distribution plot: Danceability]{{\includegraphics[width=4cm]{output_Danceability.png} }}%
    \qquad
    ...
    \qquad
    \subfloat[\centering Boxplot: Valence]{{\includegraphics[width=4cm]{output_valence_Boxplot.png} }}%
    \qquad
